...
public class PrefixSpanSolver {

    // For logging
    private static final Logger logger = LoggerFactory.getLogger(PrefixSpanSolver.class);
    ...
    private PrefixSpanStatisticsCollector statisticsCollector;

    public PrefixSpanSolver() {
    }
    ...
    public PrefixSpanStatisticsCollector getStatisticsCollector() {
        return statisticsCollector;
    }

    public void setStatisticsCollector(PrefixSpanStatisticsCollector statisticsCollector) {
     ...
     * @return The {@link PrefixSpanSolver} itself.
     */
    public PrefixSpanSolver readData(RawDataType rawDataType) {
     ...
     * @return The {@link PrefixSpanSolver} itself.
     */
    public PrefixSpanSolver cleanData() {
    ...
    public PrefixSpanSolver solve(ItemType itemType, int minsup) {
        ...
        inputFilename = "prefixspan_" + inputFilename;
    ...
    public PrefixSpanSolver solveIntegrated(ItemType itemType, int minsup) {
        String inputFilename;
        String outputFilename;
        switch (itemType) {
            case PLUNO: {
